"""Generated by tools/gen_layout.py from the live spell_dbc schema.
Do not edit."""
...
FLOAT_FIELDS = frozenset(['EffectBonusMultiplier_1', 'EffectBonusMultiplier_2', 'EffectBonusMultiplier_3', 'EffectChainAmplitude_1', 'EffectChainAmplitude_2', 'EffectChainAmplitude_3', 'EffectMultipleValue_1', 'EffectMultipleValue_2', 'EffectMultipleValue_3', 'EffectRealPointsPerLevel_1', 'EffectRealPointsPerLevel_2', 'EffectRealPointsPerLevel_3', 'Speed'])

STRING_FIELDS = frozenset(['AuraDescription_Lang_Unk', 'AuraDescription_Lang_deDE', 'AuraDescription_Lang_enCN', 'AuraDescription_Lang_enGB', 'AuraDescription_Lang_enTW', 'AuraDescription_Lang_enUS', 'AuraDescription_Lang_esES', 'AuraDescription_Lang_esMX', 'AuraDescription_Lang_frFR', 'AuraDescription_Lang_itIT', 'AuraDescription_Lang_koKR', 'AuraDescription_Lang_ptBR', 'AuraDescription_Lang_ptPT', 'AuraDescription_Lang_ruRU', 'AuraDescription_Lang_zhCN', 'AuraDescription_Lang_zhTW', 'Description_Lang_Unk', 'Description_Lang_deDE', 'Description_Lang_enCN', 'Description_Lang_enGB', 'Description_Lang_enTW', 'Description_Lang_enUS', 'Description_Lang_esES', 'Description_Lang_esMX', 'Description_Lang_frFR', 'Description_Lang_itIT', 'Description_Lang_koKR', 'Description_Lang_ptBR', 'Description_Lang_ptPT', 'Description_Lang_ruRU', 'Description_Lang_zhCN', 'Description_Lang_zhTW', 'NameSubtext_Lang_Unk', 'NameSubtext_Lang_deDE', 'NameSubtext_Lang_enCN', 'NameSubtext_Lang_enGB', 'NameSubtext_Lang_enTW', 'NameSubtext_Lang_enUS', 'NameSubtext_Lang_esES', 'NameSubtext_Lang_esMX', 'NameSubtext_Lang_frFR', 'NameSubtext_Lang_itIT', 'NameSubtext_Lang_koKR', 'NameSubtext_Lang_ptBR', 'NameSubtext_Lang_ptPT', 'NameSubtext_Lang_ruRU', 'NameSubtext_Lang_zhCN', 'NameSubtext_Lang_zhTW', 'Name_Lang_Unk', 'Name_Lang_deDE', 'Name_Lang_enCN', 'Name_Lang_enGB', 'Name_Lang_enTW', 'Name_Lang_enUS', 'Name_Lang_esES', 'Name_Lang_esMX', 'Name_Lang_frFR', 'Name_Lang_itIT', 'Name_Lang_koKR', 'Name_Lang_ptBR', 'Name_Lang_ptPT', 'Name_Lang_ruRU', 'Name_Lang_zhCN', 'Name_Lang_zhTW'])
